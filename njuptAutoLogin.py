...
class NetManager:
        ...
        try:
            if flag:
                default_config = {
                    ...
                    "netinfo":{
                        "serverip": "10.10.244.11", "redictip": "6.6.6.6", "clientip": "",
    ...
    def __gen_httpinfo(self, action) -> None:
        if action == "login":
            r = requests.get("http://{}/".format(self.config["netinfo"]["redictip"]), proxies=self.proxy)
